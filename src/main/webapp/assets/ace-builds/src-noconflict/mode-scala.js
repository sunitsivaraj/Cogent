...
var ScalaHighlightRules = function() {
    ...
    var keywords = (
            ...
            "readChar|readInt|readLong|readFloat|readDouble|cogent|data|behavior|cognitiveModel|"+
			"net|inp|outp|percepts|explanations|hypothesis|goals|goal|actions|action|constraints|explains|"+
            "contradicts|endnet|endcogent|evidence|behaviormapping|portmapping|connects|mapsto|beliefs|belief|"+
            "deduces|triggers|facilitates|incompatible|display|analogies|analogous|at"// package scala
    );
